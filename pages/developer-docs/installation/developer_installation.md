...
***Note***: Please ensure that you are using node version 8.10.0 or above. Also, when prompted to set the environment variable please set sunbird_environment=local and sunbird_instance=sunbird.
